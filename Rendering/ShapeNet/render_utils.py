...
def jitter_lights(lamps, light_parameters):
    ...
    for lamp in lamps:
        ...
        if lamp_type == 'POINT':
            ...
            strength = np.random.randint(*area_strength_range)
            temp = np.random.randint(*temp_range)
...
def set_output_paths(tree, output_path, obj_synset, obj_fname):
    ...
    segmentation_output.base_path = os.path.join(output_path, obj_synset, obj_fname, 'segmentation')
    image_output.base_path = os.path.join(output_path, obj_synset, obj_fname, 'image_output')
    depth_output.base_path = os.path.join(output_path, obj_synset, obj_fname, 'depth_output')
    normal_output.base_path = os.path.join(output_path, obj_synset, obj_fname, 'normal_output')
    albedo_output.base_path = os.path.join(output_path, obj_synset, obj_fname, 'albedo_output')
    exr_output.base_path = os.path.join(output_path, obj_synset, obj_fname, 'openEXR_output')
